...
const GalAdd = () => {
    ...
    const uploadImg = (e) => {
        ...
        if (!allowedTypes.includes(file?.type)) {
            ...
            setStatusImg(true);
            setSwalProps({...swalProps , show:true , icon:"error" , title:"Only JPEG, PNG, and GIF images are allowed."})
            setTimeout(function() {setSwalProps({...swalProps , show:false , title:"", icon:"error" , showConfirmButton:false})}, 2000);
  ...
  return (<>{console.log(chipData)}
            ...
            <Grid item xs={12} sx={{p:2}}>
                    ...
                    <Grid item xs={12} sx={{pt:2}}>
                    {
                        ...
                        : <img src={'../../image/noimg.jpg'} alt="img-blank" style={{width:"50%"}} />
                    }
                    </Grid>
